...
export const FR = {
  ...
  "bascule.geometrie":
    "la géométrie de ce format n’a pas pu être chargée, rien n’a été appliqué",
  ...
  "police.suggerees": "Dix familles, une par voix",
  "police.suggerees.note":
    "Chaque nom est écrit dans sa propre police : c’est celle que le livre imprimera.",
  "police.toutes": "Toutes les polices de cet ordinateur ({n})",
  "police.toutes.masquer": "Masquer la liste complète",
  "police.specimen": "Le vif zéphyr jubile sur les quais",
  "police.voix.grotesque": "sans empattement, neutre",
  "police.voix.humaniste": "sans empattement, chaleureuse",
  "police.voix.geometrique": "sans empattement, géométrique",
  "police.voix.ancien": "à empattements, classique",
  "police.voix.texte": "à empattements, très lisible",
  "police.voix.didone": "à empattements, contrastée",
  "police.voix.egyptienne": "empattements carrés",
  "police.voix.machine": "machine à écrire",
  "police.voix.elegant": "à empattements, élégante",
  "police.voix.mono": "à chasse fixe",
  ...
  "objet.ajouter": "Bloc de texte",
  "objet.ajouter.titre": "Poser un bloc de texte sur cette planche",
  "objet.tailler": "Redimensionner le bloc",
  "objet.tourner": "Tourner le bloc",
  "objet.supprimer": "Supprimer le bloc",
  "objet.marge": "Le bloc sort de la zone sûre : ce qui en dépasse peut être rogné. Rapprochez-le du centre.",
  "objet.deborde": "Le texte dépasse le bas du bloc. Agrandissez la boîte ou réduisez le corps : rien n'est coupé.",
  "objet.trop.large": "Un mot est plus large que le bloc. Il s'imprime entier, en dépassant : élargissez la boîte.",
  "objet.angle": "Angle",
  "objet.taille": "Corps",
  ...
  "gabarit.n.7": "sept",
  "gabarit.n.8": "huit",
  "gabarit.disp.ligne": "{n} côte à côte",
  "gabarit.disp.colonne": "{n} en colonne",
  "gabarit.disp.grille": "{n} en grille",
  "gabarit.disp.grille.dim": "{n} en grille {c} × {r}",
  "gabarit.forme.pleine_page": "pleine page",
  "gabarit.forme.cadree": "photo cadrée",
  "gabarit.forme.une_page": "{d}, sur une page",
  "gabarit.forme.deux_pleines": "deux pleines pages",
  "gabarit.forme.pleine_et": "une pleine page, {d}",
  "gabarit.forme.pleine_et_une": "une pleine page, une photo cadrée",
  "gabarit.forme.par_page": "{d} par page",
  "gabarit.forme.deux_cotes": "{a}, et {b}",
...
export const EN: Record<Cle, string> = {
  ...
  "bascule.geometrie":
    "this format’s geometry could not be loaded; nothing was applied",
  ...
  "police.suggerees": "Ten families, one per voice",
  "police.suggerees.note":
    "Each name is set in its own face: the one the book will print.",
  "police.toutes": "Every typeface on this computer ({n})",
  "police.toutes.masquer": "Hide the full list",
  "police.specimen": "Sphinx of black quartz, judge my vow",
  "police.voix.grotesque": "sans serif, neutral",
  "police.voix.humaniste": "sans serif, warm",
  "police.voix.geometrique": "sans serif, geometric",
  "police.voix.ancien": "serif, classic",
  "police.voix.texte": "serif, highly legible",
  "police.voix.didone": "serif, high contrast",
  "police.voix.egyptienne": "slab serif",
  "police.voix.machine": "typewriter",
  "police.voix.elegant": "serif, elegant",
  "police.voix.mono": "monospaced",
  ...
  "objet.ajouter": "Text block",
  "objet.ajouter.titre": "Place a text block on this spread",
  "objet.tailler": "Resize the block",
  "objet.tourner": "Turn the block",
  "objet.supprimer": "Delete the block",
  "objet.marge": "The block sits outside the safe area: what runs past it may be trimmed away. Move it inward.",
  "objet.deborde": "The text runs past the bottom of the block. Make the box taller or the type smaller: nothing is cut.",
  "objet.trop.large": "One word is wider than the block. It prints whole, past the edge: widen the box.",
  "objet.angle": "Angle",
  "objet.taille": "Size",
  ...
  "gabarit.n.7": "seven",
  "gabarit.n.8": "eight",
  "gabarit.disp.ligne": "{n} side by side",
  "gabarit.disp.colonne": "{n} stacked",
  "gabarit.disp.grille": "{n} in a grid",
  "gabarit.disp.grille.dim": "{n} in a {c} × {r} grid",
  "gabarit.forme.pleine_page": "full page",
  "gabarit.forme.cadree": "framed photo",
  "gabarit.forme.une_page": "{d}, on one page",
  "gabarit.forme.deux_pleines": "two full pages",
  "gabarit.forme.pleine_et": "one full page, {d}",
  "gabarit.forme.pleine_et_une": "one full page, one framed photo",
  "gabarit.forme.par_page": "{d} per page",
  "gabarit.forme.deux_cotes": "{a}, and {b}",
